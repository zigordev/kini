...
export class InitialSchema1788862869781 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_user_email" ON "kini_user"  ("email") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "team" DROP CONSTRAINT "FK_a5111ebcad0cc858f6527f1f60a"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_226899ce08545d3b1c90022a1b"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_team_membership_invited_email"`,
    );
